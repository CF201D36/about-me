...
function quizLaunch() {
  ...
  if (startGame === true) {
    ...
    // Question 6 -- Complex Random Number Game
    if (userQuit !== true) {
      ...
      do {
        ...
        console.log('You answered \'' + myGuess + '\' with ' + myAttempts + ' out of 6 attempts remaining.');
